/**
 * DatePicker base (sin react-hook-form).
 * Úsalo mediante `DatePickerForm` o `DatePickerField` según el caso.
 */
"use client";
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <Calendar
          ...
          classNames={{
            day_today:
              "bg-primary/30 text-primary-foreground ring-1 ring-primary/40 hover:bg-primary/35",
          }}
          disabled={(date) => {
