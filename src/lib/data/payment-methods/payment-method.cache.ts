...
export const paymentMethodGetAllByCompanyCached = async (
  companyId: string
...
// export async function paymentMethodGetAllByCompanyCachedOld(companyId: string): Promise<ResponseAction> {
